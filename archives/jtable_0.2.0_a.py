...
class jtable_cls:
    ...
    # def cross_path(self,dataset,path_level=0):
    #     if path_level < len(self.path_splitted):
    #         print('debug path_level: ' + str(path_level))
    #         current_step = str(self.path_splitted[path_level])
    #         print('debug current_step: ' + str(current_step))
    #         expr_end_by_braces=(re.sub('.*({).*(})$',r'\1\2',current_step))
    #         print('debug expr_end_by_braces: ' + expr_end_by_braces)
    #         if expr_end_by_braces == "{}":
    #             pass
    #         else:
    #             self.cross_path(dataset,path_level + 1)
    #     else:
    #         current_path_splitted = self.path_splitted[0:path_level + 1]
    #         print('debug current_path_splitted: ' + str(current_path_splitted))
